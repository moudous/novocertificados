...
class ListaParticipante extends Model
{
    ...
    protected $fillable = ['participante_id','novo_certificado_id','ativo','codigo','arquivo_pdf','dados_personalizados','snapshot_dados','snapshot_template','gerado_em','erro_geracao'];
