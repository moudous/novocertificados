    ...
    public function generate(ListaParticipante $item): void
    {
        ...
        try {
            ...
            $context = [
                ...
                'eventos' => ['periodos' => $emissao->evento?->periodos],
                'atividades' => ['periodos' => $emissao->atividade?->periodos],
                ...
                'emissao' => ['nome' => $emissao->nome, 'data' => ($emissao->data_emissao ?: now())->format('d/m/Y'), 'carga_horaria' => data_get($item->dados_personalizados, 'carga_horaria', $emissao->carga_horaria)],
