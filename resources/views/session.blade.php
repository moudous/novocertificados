...
<div class="page-container">
    <header class="mb-4 d-flex flex-wrap justify-content-between align-items-start gap-3"><div><h1 class="page-title">Certificados</h1><p class="page-description mb-0">Sessão criada com segurança pelo GI.</p></div><div class="d-flex flex-wrap gap-2">@if(in_array('participantes.listar', (array)data_get($context, 'permissoes', []), true))<a href="{{ route('participantes.index') }}" class="btn btn-primary"><i class="bi bi-person-vcard-fill me-2"></i>Participantes</a>@endif<a href="{{ route('pessoas.index') }}" class="btn btn-outline-primary"><i class="bi bi-people-fill me-2"></i>Pessoas</a></div></header>
