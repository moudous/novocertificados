...
<form method="POST" action="{{ $participante->exists ? route('participantes.update', $params) : route('participantes.store') }}">
    ...
    <div class="card content-card"><div class="card-header"><h2 class="h5 fw-bold mb-0">Dados do participante</h2></div><div class="card-body p-4">
        ...
        <div class="row g-3">
            ...
            <div class="col-12 col-md-6"><label for="email2" class="form-label">E-mail 2</label><input id="email2" type="email" name="email2" class="form-control" maxlength="150" value="{{ old('email2', $participante->email2) }}"></div>
            <div class="col-12 col-md-6"><label for="email_institucional" class="form-label">E-mail institucional</label><input id="email_institucional" type="email" name="email_institucional" class="form-control" maxlength="150" value="{{ old('email_institucional', $participante->email_institucional) }}"></div>
            <div class="col-12 col-md-6"><label for="instituicao_ensino" class="form-label">Instituição de ensino</label><input id="instituicao_ensino" name="instituicao_ensino" class="form-control" maxlength="80" value="{{ old('instituicao_ensino', $participante->instituicao_ensino) }}"></div>
