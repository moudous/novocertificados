...
<div class="alert alert-secondary"><strong>Unificação desfeita.</strong> Esta ação foi executada em {{ $unificacao->desfeito_em?->format('d/m/Y H:i:s') ?: '—' }} e não pode ser repetida.</div>
